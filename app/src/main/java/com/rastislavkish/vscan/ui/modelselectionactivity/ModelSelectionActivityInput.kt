...
@Serializable
data class ModelSelectionActivityInput(
    val displayedModels: DisplayedModels=DisplayedModels.ALL,
    ) {

    fun toIntent(launchingActivity: androidx.fragment.app.FragmentActivity): Intent {
        val intent=Intent(launchingActivity, ModelSelectionActivity::class.java)
    ...
    companion object {
        ...
        fun fromIntent(intent: Intent?, caller: String): ModelSelectionActivityInput {
            val key="input"
            ...
            if (intent!=null) {
                ...
                if (extras!=null) {
                    ...
                    try {
                        return Json.decodeFromString<ModelSelectionActivityInput>(json)
                        }
                    catch (e: Exception) {
