    ...
    companion object {
        ...
        val presets=listOf<ProviderParams>(
            ...
            ProviderParams("Anthropic",
                ...
                mapOf(
                    "vscan-claude-opus-4.8" to "claude-opus-4-8",
                    "vscan-claude-opus-4.7" to "claude-opus-4-7",
                    "vscan-claude-sonnet-4.6" to "claude-sonnet-4-6",
                    "vscan-claude-haiku-4.5" to "claude-haiku-4-5",
                    "vscan-claude-opus-4.6" to "claude-opus-4-6",
                    "vscan-claude-sonnet-4.5" to "claude-sonnet-4-5",
                    "vscan-claude-opus-4.5" to "claude-opus-4-5",
            ...
            ProviderParams("Google",
                ...
                mapOf(
                    "vscan-gemini-3.5-flash" to "gemini-3.5-flash",
            ...
            ProviderParams("Mistral",
                ...
                mapOf(
                    "vscan-mistral-medium-3.5" to "mistral-medium-2604",
            ...
            ProviderParams("OpenRouter",
                ...
                mapOf(
                    ...
                    "vscan-claude-opus-4.8" to "anthropic/claude-opus-4.8",
                    ...
                    "vscan-gemini-3.5-flash" to "google/gemini-3.5-flash",
                    ...
                    "vscan-mistral-medium-3.5" to "mistralai/mistral-medium-3-5",
                    ...
                    "vscan-mimo-v2.5" to "xiaomi/mimo-v2.5",
            ...
            ProviderParams("NanoGPT",
                ...
                mapOf(
                    ...
                    "vscan-glm-4.5v" to "z-ai/glm-4.5v",
                    "vscan-mistral-medium-3.5" to "mistral/mistral-medium-3.5",
