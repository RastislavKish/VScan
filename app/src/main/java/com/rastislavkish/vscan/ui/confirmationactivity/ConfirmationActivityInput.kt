...
@Serializable
data class ConfirmationActivityInput(
    val text: String,
    val additionalData: String="",
    ) {

    fun toIntent(launchingActivity: androidx.appcompat.app.AppCompatActivity): Intent {
        val intent=Intent(launchingActivity, ConfirmationActivity::class.java)
    ...
    companion object {
        ...
        fun fromIntent(intent: Intent?, caller: String): ConfirmationActivityInput {
            val key="input"
            ...
            if (intent!=null) {
                ...
                if (extras!=null) {
                    ...
                    try {
                        return Json.decodeFromString<ConfirmationActivityInput>(json)
                        }
                    catch (e: Exception) {
