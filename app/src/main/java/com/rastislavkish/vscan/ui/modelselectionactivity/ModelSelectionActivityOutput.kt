...
@Serializable
data class ModelSelectionActivityOutput(
    val model: String,
    ) {

    companion object {

        fun fromIntent(intent: Intent?, caller: String): ModelSelectionActivityOutput {
            val key="result"
            ...
            if (intent!=null) {
                ...
                if (extras!=null) {
                    ...
                    try {
                        return Json.decodeFromString<ModelSelectionActivityOutput>(json)
                        }
                    catch (e: Exception) {
