...
data class ProviderActivityInput(
    ...
    companion object {
        ...
        fun fromIntent(intent: Intent?, caller: String): ProviderActivityInput {
            val key="input"
            ...
            if (intent!=null) {
                ...
                if (extras!=null) {
                    ...
                    try {
                        return Json.decodeFromString<ProviderActivityInput>(json)
                        }
                    catch (e: Exception) {
