...
@Serializable
data class ModelIdActivityOutput(
    val mapping: ModelToIdMapping,
    ) {
    ...
    companion object {
        ...
        fun fromIntent(intent: Intent?, caller: String): ModelIdActivityOutput {
            val key="result"
            ...
            if (intent!=null) {
                ...
                if (extras!=null) {
                    ...
                    try {
                        return Json.decodeFromString<ModelIdActivityOutput>(json)
                        }
                    catch (e: Exception) {
