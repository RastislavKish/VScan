...
data class ProviderPresetSelectionActivityOutput(
    ...
    companion object {
        ...
        fun fromIntent(intent: Intent?, caller: String): ProviderPresetSelectionActivityOutput {
            val key="result"
            ...
            if (intent!=null) {
                ...
                if (extras!=null) {
                    ...
                    try {
                        return Json.decodeFromString<ProviderPresetSelectionActivityOutput>(json)
                        }
                    catch (e: Exception) {
