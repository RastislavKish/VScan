...
@Serializable
data class TextInputActivityOutput(
    val text: String,
    val context: String,
    ) {
    ...
    companion object {
        ...
        fun fromIntent(intent: Intent?, caller: String): TextInputActivityOutput {
            val key="result"
            ...
            if (intent!=null) {
                ...
                if (extras!=null) {
                    ...
                    try {
                        return Json.decodeFromString<TextInputActivityOutput>(json)
                        }
                    catch (e: Exception) {
